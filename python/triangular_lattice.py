...
def triangular(StdI: StdIntList) -> None:
    ...
    if StdI.model == "spin":
        ...
        nintrMax = (StdI.NCell * (StdI.NsiteUC + 3 + 3 + 3)
                    * (3 * StdI.S2 + 1) * (3 * StdI.S2 + 1))
    else:
        ntransMax = StdI.NCell * 2 * (2 * StdI.NsiteUC + 6 + 6 + 6)
        nintrMax = StdI.NCell * (StdI.NsiteUC + 4 * (3 + 3 + 3))
        if StdI.model == "kondo":
    ...
    for kCell in range(StdI.NCell):
        ...
        isite, jsite, Cphase, dR = set_label(StdI, fp, iW, iL, 1, -1, 0, 0, 1)
        if StdI.model == "spin":
        ...
        isite, jsite, Cphase, dR = set_label(StdI, fp, iW, iL, 2, -1, 0, 0, 2)
        if StdI.model == "spin":
        ...
        isite, jsite, Cphase, dR = set_label(StdI, fp, iW, iL, -1, 2, 0, 0, 2)
        if StdI.model == "spin":
        ...
        isite, jsite, Cphase, dR = set_label(StdI, fp, iW, iL, 2, -2, 0, 0, 3)
        if StdI.model == "spin":
