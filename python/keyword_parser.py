...
def parse_hphi_keyword(keyword: str, value: str, StdI: StdIntList) -> bool:
    ...
    bool
        True if the keyword was recognised, False otherwise.
    """
    return _apply_keyword_table(_HPHI_KEYWORDS, keyword, value, StdI)


def parse_mvmc_keyword(keyword: str, value: str, StdI: StdIntList) -> bool:
    ...
    bool
        True if the keyword was recognised, False otherwise.
    """
    return _apply_keyword_table(_MVMC_KEYWORDS, keyword, value, StdI)


def parse_uhf_keyword(keyword: str, value: str, StdI: StdIntList) -> bool:
    ...
    bool
        True if the keyword was recognised, False otherwise.
    """
    return _apply_keyword_table(_UHF_KEYWORDS, keyword, value, StdI)


def parse_hwave_keyword(keyword: str, value: str, StdI: StdIntList) -> bool:
    ...
    bool
        True if the keyword was recognised, False otherwise.
    """
    return _apply_keyword_table(_HWAVE_KEYWORDS, keyword, value, StdI)
