...
def chain(StdI: StdIntList) -> None:
    ...
    if StdI.model == "spin":
        ...
        for isite in range(StdI.nsite // 2):
            StdI.locspinflag[isite] = StdI.S2
...
def chain_boost(StdI: StdIntList) -> None:
    ...
    fp.write(f"{-0.5 * StdI.Gamma:25.15e} "
    ...
    fp.write("# J 1\n")
    for i in range(3):
        fp.write(f"{0.25 * StdI.J0[i, 0]:25.15e} "
                 f"{0.25 * StdI.J0[i, 1]:25.15e} "
                 f"{0.25 * StdI.J0[i, 2]:25.15e}\n")
    fp.write("# J 2\n")
    for i in range(3):
        fp.write(f"{0.25 * StdI.Jp[i, 0]:25.15e} "
                 f"{0.25 * StdI.Jp[i, 1]:25.15e} "
                 f"{0.25 * StdI.Jp[i, 2]:25.15e}\n")
    ...
    for ipivot in range(StdI.num_pivot):
        ...
        StdI.list_6spin_pair[ipivot, 6, 0] = 1
        # Interaction 1: type 1
        ...
        StdI.list_6spin_pair[ipivot, 6, 1] = 1
        # Interaction 2: type 1
        ...
        StdI.list_6spin_pair[ipivot, 6, 2] = 1
        # Interaction 3: type 1
        ...
        StdI.list_6spin_pair[ipivot, 6, 3] = 1
        # Interaction 4: type 2
        ...
        StdI.list_6spin_pair[ipivot, 6, 4] = 2
        # Interaction 5: type 2
        ...
        StdI.list_6spin_pair[ipivot, 6, 5] = 2
        # Interaction 6: type 2
        ...
        StdI.list_6spin_pair[ipivot, 6, 6] = 2
        # Interaction 7: type 2
        ...
        StdI.list_6spin_pair[ipivot, 6, 7] = 2
